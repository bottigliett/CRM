...
export interface FormSchema {
  fields: FormField[]
  pages: { title: string }[]
  settings: { reviewBeforeSubmit: boolean; notifyRoles: string[]; style?: { primaryColor?: string; backgroundColor?: string; alignment?: 'center' | 'left' | 'right'; inputSize?: 'sm' | 'md' | 'lg'; showBanner?: boolean } }
}
