...
interface SearchItem {
  ...
  group: string
  icon?: LucideIcon
  module?: string // nome del modulo per il controllo dei permessi
  requiresSuperAdmin?: boolean // true se richiede SUPER_ADMIN
}
...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const allSearchItems: SearchItem[] = [
    // Dashboard
    { title: "Dashboard", url: "/dashboard", group: "Dashboard", icon: LayoutDashboard, module: "dashboard" },

    // CRM
    { title: "Lead Board", url: "/lead-board", group: "CRM", icon: Target, module: "lead_board" },
    { title: "Contatti", url: "/contacts", group: "CRM", icon: Users, module: "contacts" },

    // Gestione
    { title: "Calendario", url: "/calendar", group: "Gestione", icon: Calendar, module: "calendar" },
    { title: "Task", url: "/tasks", group: "Gestione", icon: CheckSquare, module: "tasks" },
    { title: "Finanze", url: "/finance", group: "Gestione", icon: DollarSign, module: "finance" },
    { title: "Fatture", url: "/invoices", group: "Gestione", icon: FileText, module: "invoices" },

    // Amministrazione
    { title: "Utenti", url: "/users", group: "Amministrazione", icon: Users, requiresSuperAdmin: true },
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="overflow-hidden p-0 shadow-2xl border border-zinc-200 dark:border-zinc-800 max-w-[640px]">
        ...
        >
          <CommandInput placeholder="Cosa cerchi?" autoFocus />
          <CommandList>
